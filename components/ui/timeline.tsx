...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn("flex list-inside flex-col", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "absolute left-8 top-[5px] h-full w-0.5 -translate-x-1/2 translate-y-2 bg-primary",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("flex size-4 flex-col rounded-full bg-primary", className)}
    {...props}
  />
));
