...
import LinkTransition from "../utils/animations/link-transition";
import WaveReveal from "../utils/animations/text/wave-reveal";
...
export default function ConnectMe() {
  ...
  return (
    <div className="relative z-10 mx-auto flex h-full w-full max-w-5xl flex-col items-center overflow-hidden px-10">
      <div className="flex w-full flex-col space-y-8" ref={ref}>
        {isInView && (
          <WaveReveal
            text="Want to Start a Project?"
            className="text-pretty font-clashDisplay text-2xl md:text-4xl lg:text-6xl"
            duration="1000ms"
          />
        )}
        <LinkTransition
