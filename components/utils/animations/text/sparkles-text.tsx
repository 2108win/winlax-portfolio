...
interface SparklesTextProps {
  ...
  /**
   * @default "{first: '#0ABFBC', second: '#FE8FB5'}"
   * @type string
   * @description
   ...
   * @type string
   * @description
   * The position of the aura
   */
  auraPosition?: "left" | "right";
...
const SparklesText: React.FC<SparklesTextProps> = ({
  text,
  colors = { first: "#FE8FB5", second: "#0ABFBC" },
  className,
  sparklesCount = 10,
  auraPosition,
  textColorClass,
        ...
        {auraPosition && (
          <div className="pointer-events-none absolute inset-0 z-[-1] justify-center rounded-full">
            <div
              ...
              className={cn(
                "pointer-events-none absolute top-0 h-full w-1/2 animate-cursorAnimate-one rounded-full opacity-70 blur-[10vw] lg:blur-[4vw]",
                auraPosition === "left" && "left-0",
                auraPosition === "right" && "right-0",
              )}
            />
            <div
              style={{
              ...
              className={cn(
                "pointer-events-none absolute top-0 h-full w-1/2 animate-cursorAnimate-two rounded-full opacity-70 blur-[10vw] md:blur-[3vw]",
                auraPosition === "left" && "left-0",
                auraPosition === "right" && "right-0",
              )}
            />
